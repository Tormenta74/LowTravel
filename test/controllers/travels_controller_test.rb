...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post travels_url, params: { travel: { content: @travel.content, title: @travel.title, user_id: @travel.user_id } }
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { content: @travel.content, title: @travel.title, user_id: @travel.user_id } }
